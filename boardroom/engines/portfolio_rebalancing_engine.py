...
class RebalanceStockAuditStage(BoardroomStage):
    ...
    def execute(self, context: BoardroomContext) -> Optional[str]:
        ...
        growthPrompt = (
            ...
            f"with a list of your shortlisted candidate tickers. DO NOT finalise or output your candidate table after Step 1 alone! 'fetchStocksInSector' only provides heuristic scores. "
...
class RebalanceStockProposalStage(BoardroomStage):
    ...
    def execute(self, context: BoardroomContext) -> Optional[str]:
        ...
        aggProposalPrompt = (
            ...
            f"Task: Review and scrutinise BOTH the Growth Hunter candidates and Defensive/Value Hunter candidates from an aggressive, high-upside risk perspective against the CURRENT BASELINE HOLDINGS. Construct your final aggressive stock rebalancing proposal for {promptArgs['initialCapital']}.\n\n"
            f"Instructions:\n"
        ...
        consProposalPrompt = (
            ...
            f"Growth Candidates Scouted in Phase 4:\n{growthRaw}\n\n"
            f"Defensive Candidates Scouted in Phase 4:\n{valueRaw}\n\n"
            f"Task: Review and scrutinise BOTH the Growth Hunter candidates and Defensive/Value Hunter candidates from a conservative, risk-managed capital-preservation perspective against the CURRENT BASELINE HOLDINGS. Construct your final conservative stock rebalancing proposal for {promptArgs['initialCapital']}.\n\n"
            f"Instructions:\n"
